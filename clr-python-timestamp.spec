...
Version  : 15
Release  : 30
URL      : http://localhost/cgit/projects/clr-python-timestamp/snapshot/clr-python-timestamp-15.tar.gz
Source0  : http://localhost/cgit/projects/clr-python-timestamp/snapshot/clr-python-timestamp-15.tar.gz
...
%prep
%setup -q -n clr-python-timestamp-15
...
export LANG=C
export SOURCE_DATE_EPOCH=1527916066
