...
Version  : 13
Release  : 26
URL      : http://localhost/cgit/projects/clr-python-timestamp/snapshot/clr-python-timestamp-13.tar.gz
Source0  : http://localhost/cgit/projects/clr-python-timestamp/snapshot/clr-python-timestamp-13.tar.gz
...
%prep
%setup -q -n clr-python-timestamp-13
...
export LANG=C
export SOURCE_DATE_EPOCH=1523028062
